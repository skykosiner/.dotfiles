...
normal("<silent> <leader>h", ":lua print(vim.inspect(require('refactoring').debug.get_path()))<CR>")
normal("<silent> <leader>g", ":lua require('refactoring').debug.printf({below = false})<CR>")
