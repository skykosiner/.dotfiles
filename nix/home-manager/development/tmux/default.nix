...
in {
  ...
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind C-c display-popup -w 100 -h 30 "$SHELL -c 'tte -i ~/personal/kirk-ascii/test.txt --frame-rate 900 --canvas-width 0 --canvas-height 0 --reuse-canvas --anchor-canvas c --anchor-text c --existing-color-handling always print; read'"
